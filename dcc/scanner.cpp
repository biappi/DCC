...
static void shift(Int i) {
    ...
    static byte uf[8] = {0, 0, Cf, Cf, 0, 0, 0, 0};
    static byte df[8] = {Cf,           Cf,           Cf, Cf,
                         Sf | Zf | Cf, Sf | Zf | Cf, 0,  Sf | Zf | Cf};
...
static void trans(Int i) {
    ...
    if ((byte)REG(*pInst) < 2 || !(stateTable[i].flg & B)) { /* INC & DEC */
        ...
        else if (pIcode->ic.ll.opcode == iINC ||
                 pIcode->ic.ll.opcode == iPUSH || pIcode->ic.ll.opcode == iDEC)
...
static void arith(Int i) {
    ...
    static byte df[8] = {
        Sf | Zf | Cf, 0,           0, Sf | Zf | Cf, Sf | Zf | Cf, Sf | Zf | Cf,
        Sf | Zf | Cf, Sf | Zf | Cf};
